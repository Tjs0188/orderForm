...
var createEmptyRow = function createEmptyRow() {
  ...
  cell.classList.add("px-6 py-4 whitespace-nowrap text-lg font-medium text-gray-500 text-center".split());
