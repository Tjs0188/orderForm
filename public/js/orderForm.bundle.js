...
var initializePackagesTable = function initializePackagesTable() {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return axios__WEBPACK_IMPORTED_MODULE_0__["default"].get("/orderform/packageItems", {
              params: {
  ...
  function createEditableTableRow(item, itemClass) {
    ...
    var tableRowClasses = ["px-6", "py-4", "whitespace-nowrap", "text-sm", "font-medium", "text-gray-800", "odd:bg-white", "even:bg-blue", itemClass];
    var inputClasses = ["py-2", "px-2", "block", "w-full", "border-0", "border-transparent", "text-sm", "focus:border-blue-500", "focus:ring-blue-500", "disabled:opacity-50", "disabled:pointer-events-none"];
    (_tableRow$classList = tableRow.classList).add.apply(_tableRow$classList, tableRowClasses);
    ...
    (_categoryInput$classL = categoryInput.classList).add.apply(_categoryInput$classL, inputClasses);
    ...
    (_productNumberInput$c = productNumberInput.classList).add.apply(_productNumberInput$c, inputClasses);
    var descriptionInput = document.createElement("input");
    descriptionInput.type = "text";
    descriptionInput.value = item.description;
    descriptionInput.name = "".concat(itemClass, "[description][]");
    (_descriptionInput$cla = descriptionInput.classList).add.apply(_descriptionInput$cla, inputClasses);
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 4;
          return axios__WEBPACK_IMPORTED_MODULE_0__["default"].get("/orderform/template", {
            params: {
